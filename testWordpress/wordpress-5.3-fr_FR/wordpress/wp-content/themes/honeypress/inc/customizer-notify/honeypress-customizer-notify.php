...
class Honeypress_Customizer_Notify {
	...
	public function setup_actions() {
		...
		add_action( 'customize_register', array( $this, 'honeypress_plugin_notification_customize_register' ) );

		// Enqueue scripts and styles
		add_action( 'customize_controls_enqueue_scripts', array( $this, 'honeypress_customizer_notify_scripts_for_customizer' ), 0 );

		/* ajax callback for dismissable recommended actions */
		add_action( 'wp_ajax_quality_customizer_notify_dismiss_action', array( $this, 'honeypress_customizer_notify_dismiss_recommended_action_callback' ) );

		add_action( 'wp_ajax_ti_customizer_notify_dismiss_recommended_plugins', array( $this, 'honeypress_customizer_notify_dismiss_recommended_plugins_callback' ) );

	}

	
	public function honeypress_customizer_notify_scripts_for_customizer() {
	...
	public function honeypress_plugin_notification_customize_register( $wp_customize ) {
	...
	public function honeypress_customizer_notify_dismiss_recommended_action_callback() {
	...
	public function honeypress_customizer_notify_dismiss_recommended_plugins_callback() {
