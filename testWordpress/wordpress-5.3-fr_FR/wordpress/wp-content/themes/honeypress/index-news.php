					...
					<article class="post">	
	                        <?php if(has_post_thumbnail()){ ?>
								<figure class="post-thumbnail">
	                                ...
	                                <a href="<?php the_permalink(); ?>" tabindex="-1"><?php the_post_thumbnail('',$thumb_class);?></a>	
	                            </figure>	
							<?php } ?>
							<div class="post-content">	
								...
								<header class="entry-header">
									...
									if(get_theme_mod('blog_meta_section_enable',true)==true):?>
									<div class="entry-meta">
										<span class="author"><a <?php if(is_rtl()){echo 'dir="rtl"';} ?> href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) );?>"><?php esc_html_e('By','honeypress');?> <?php echo get_the_author();?></a></span>
										<span class="posted-on">
											<a <?php if(is_rtl()){echo 'dir="rtl"';} ?> href="<?php echo esc_url( home_url() ); ?>/<?php echo esc_html(date( 'Y/m' , strtotime( get_the_date() )) ); ?>"><time><?php echo get_the_date();?></time></a>
										</span>
										<span class="comment-links"><a <?php if(is_rtl()){echo 'dir="rtl"';} ?> href="<?php the_permalink(); ?>#respond"><?php echo get_comments_number();?></a></span>
									</div>	
									<?php endif;?>
