				...
				<div class="honeypress-page">
					...
					<div class="honeypress-page-content">
						<ul class="honeypress-page-list-flex">
							...
							if ( is_plugin_active( 'honeypress-plus/honeypress-plus.php' ) ):
						
							?>
			
							<li class="">
								<a class="honeypress-page-quick-setting-link" href="<?php echo esc_url( admin_url( 'customize.php?autofocus[section]=theme_style' ) ); ?>" target="_blank"><?php esc_html_e('Theme Color Schemes','honeypress'); ?></a>
							</li>
							...
							<li class="">
								<a class="honeypress-page-quick-setting-link" href="<?php echo esc_url( admin_url( 'customize.php?autofocus[section]=frontpage_layout' ) ); ?>" target="_blank"><?php esc_html_e('Homepage Section Ordering','honeypress'); ?></a>
							</li>
							<?php endif; ?>  
						</ul>
					</div>
			...
			<div class="col-md-6"> 
				<div class="honeypress-page">
					...
					<div class="honeypress-page-content">
						<ul class="honeypress-page-list-flex">
							<li class="">
								<a class="honeypress-page-quick-setting-link" href="<?php echo 'https://demo.spicethemes.com/?theme=HoneyPress'; ?>" target="_blank"><?php echo esc_html__('HoneyPress Demo','honeypress'); ?></a>
							</li>
							<li class="">
								<a class="honeypress-page-quick-setting-link" href="<?php echo 'https://demo.spicethemes.com/?theme=HoneyPress%20Pro'; ?>" target="_blank"><?php echo esc_html__('HoneyPress Pro Demo','honeypress'); ?></a>
							</li>
							
							<li class="">
								<a class="honeypress-page-quick-setting-link" href="<?php echo 'https://wordpress.org/support/theme/honeypress/'; ?>" target="_blank"><?php echo esc_html__('HoneyPress Theme Support','honeypress'); ?></a>
							</li>
							
						    <li class=""> 
								<a class="honeypress-page-quick-setting-link" href="<?php echo 'https://wordpress.org/support/theme/honeypress/reviews/#new-post'; ?>" target="_blank"><?php echo esc_html__('Your feedback is valuable to us','honeypress'); ?></a>
							</li>
							...
							<li class=""> 
								<a class="honeypress-page-quick-setting-link" href="<?php echo 'https://helpdoc.spicethemes.com/honeypress/honeypress-wordpress-theme/'; ?>" target="_blank"><?php echo esc_html__('HoneyPress Documentation','honeypress'); ?></a>
							</li>
