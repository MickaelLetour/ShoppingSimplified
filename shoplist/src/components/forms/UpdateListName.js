                    ...
                    <div> {/* input wrapper */}
                        ...
                        <h6>Leters and Number Only</h6>
                            <input /* input for List name */
                                ...
                                placeholder={"Previous Name: "+this.props.placeholder} //loads previus corresponding listname to placeholder
                        ...
                        <div className="logbuttons">{/* buttons wrapper */}
                            <button type="button" 
                                ...
                                <NavLink to={"/Shoplist"}>Cancel</NavLink></button> {/* send user to "../Shoplist" on Click */}
                            <button 
