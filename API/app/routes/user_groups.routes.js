module.exports = app => {
    ...
    app.get("/user_groups/userpower=/:userId", user_groups.findOneUserinGroups);

    // Retrieve a single group with groupId
    app.get("/user_groups/powerinnumbers=/:groupId", user_groups.findOneGroupofUsers);
 
    // Delete a user with userId
    app.delete("/user_groups/:userId&:groupId", user_groups.delete);
  
     // Create a new user
    app.delete("/user_groups/delall", user_groups.deleteAll); 
  };